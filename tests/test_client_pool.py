...
class TestUrlValidation:
    ...
    def test_validate_url_allowlist_pass(self):
        ...
        pool = CMLClientPool(
            allowed_urls=["https://cml.example.com", "https://cml2.example.com"]
        )
    ...
    def test_validate_url_allowlist_fail(self):
        ...
        pool = CMLClientPool(
            allowed_urls=["https://cml.example.com"]
        )
    ...
    def test_validate_url_allowlist_normalized_match(self):
        ...
        pool = CMLClientPool(
            allowed_urls=["https://cml.example.com:443"]  # With explicit default port
        )
    ...
    def test_validate_url_pattern_pass(self):
        ...
        pool = CMLClientPool(
            url_pattern=r"^https://cml[0-9]+\.example\.com$"
        )
    ...
    def test_validate_url_both_allowlist_and_pattern(self):
        ...
        pool = CMLClientPool(
            allowed_urls=["https://cml1.example.com"],
    ...
    def test_validate_url_in_allowlist_but_not_pattern(self):
        ...
        pool = CMLClientPool(
            allowed_urls=["https://cml.other.com"],  # In allowlist
            url_pattern=r"^https://.*\.example\.com$"  # But doesn't match pattern
        )
        with pytest.raises(McpError) as exc_info:
